...
- //bazel:proto_package.bzl for xds_proto_package and udpa_proto_package
- //bazel:cc_test.bzl for xds_cc_test and udpa_cc_test
- //bazel:go_test.bzl for xds_go_test and udpa_go_test
"""
