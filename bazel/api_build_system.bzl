...
- Use //bazel:proto_package.bzl for xds_proto_package and udpa_proto_package
- Use //bazel:cc_test.bzl for xds_cc_test and udpa_cc_test
- Use //bazel:go_test.bzl for xds_go_test and udpa_go_test
...
#   - xds_proto_package and udpa_proto_package from //bazel:proto_package.bzl
#   - xds_cc_test and udpa_cc_test from //bazel:cc_test.bzl
#   - xds_go_test and udpa_go_test from //bazel:go_test.bzl
