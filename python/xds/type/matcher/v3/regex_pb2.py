...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_REGEXMATCHER']._serialized_end=248
  _globals['_REGEXMATCHER_GOOGLERE2']._serialized_start=217
  _globals['_REGEXMATCHER_GOOGLERE2']._serialized_end=228
