...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CELEXPRESSION']._serialized_end=612
  _globals['_CELEXTRACTSTRING']._serialized_start=615
  _globals['_CELEXTRACTSTRING']._serialized_end=773
