...
func file_udpa_annotations_migrate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_udpa_annotations_migrate_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_udpa_annotations_migrate_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_udpa_annotations_migrate_proto_msgTypes[2].Exporter = func(v any, i int) any {
