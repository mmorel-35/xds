...
func file_xds_core_v3_resource_locator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_xds_core_v3_resource_locator_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_xds_core_v3_resource_locator_proto_msgTypes[1].Exporter = func(v any, i int) any {
