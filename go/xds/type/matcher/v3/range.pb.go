...
func file_xds_type_matcher_v3_range_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_xds_type_matcher_v3_range_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_xds_type_matcher_v3_range_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_xds_type_matcher_v3_range_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_xds_type_matcher_v3_range_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_xds_type_matcher_v3_range_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_xds_type_matcher_v3_range_proto_msgTypes[5].Exporter = func(v any, i int) any {
