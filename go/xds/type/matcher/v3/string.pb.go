...
const file_xds_type_matcher_v3_string_proto_rawDesc = "" +
	"\n" +
	" xds/type/matcher/v3/string.proto\x12\x13xds.type.matcher.v3\x1a\x1bxds/core/v3/extension.proto\x1a\x1fxds/type/matcher/v3/regex.proto\x1a\x1bbuf/validate/validate.proto\"\xd6\x02\n" +
	...
	"\x06suffix\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01H\x00R\x06suffix\x12J\n" +
	"\n" +
	"safe_regex\x18\x05 \x01(\v2!.xds.type.matcher.v3.RegexMatcherB\x06\xbaH\x03\xc8\x01\x01H\x00R\tsafeRegex\x12%\n" +
	...
	"\bpatterns\x18\x01 \x03(\v2\".xds.type.matcher.v3.StringMatcherB\b\xbaH\x05\x92\x01\x02\b\x01R\bpatternsB\xcb\x01\n" +
	"\x17com.xds.type.matcher.v3B\vStringProtoP\x01Z4github.com/cncf/xds/go/xds/type/matcher/v3;matcherv3\xa2\x02\x03XTM\xaa\x02\x13Xds.Type.Matcher.V3\xca\x02\x13Xds\\Type\\Matcher\\V3\xe2\x02\x1fXds\\Type\\Matcher\\V3\\GPBMetadata\xea\x02\x16Xds::Type::Matcher::V3b\x06proto3"
