...
func file_xds_type_v3_range_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_xds_type_v3_range_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_xds_type_v3_range_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_xds_type_v3_range_proto_msgTypes[2].Exporter = func(v any, i int) any {
